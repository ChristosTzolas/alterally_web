<?php
	...
	$name = $_POST['name']; 
	$phone = $_POST['phone']; 
	$lat = $_POST['lat']; // Assuming you're collecting latitude
	$lng = $_POST['lng']; // Assuming you're collecting longitude
	...
	elseif (mysqli_num_rows($result2) > 0) {
		...
		$query = "INSERT INTO users(username, password, email, name, phone, latitude, longitude,role) VALUES('$username', '$hashedPassword', '$email', '$name', '$phone', '$lat', '$lng','citizen')";
